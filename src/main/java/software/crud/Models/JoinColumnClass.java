...
public class JoinColumnClass {
    ...
    public JoinColumnClass(String tableName2, String fieldName2, String tableName1, String tableChar2,
            String fieldName1, ColumnModel column2Data, ColumnModel column1Data) {
